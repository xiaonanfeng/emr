...
<head>
    ...
    <script>
        ...
        var inputId = '${param.flag}';//关闭页面时给哪个input赋值，从url的para里获得
        $(document).ready(function () {
            ...
            //确定按钮，关闭层，并赋值
            $("#sure").click(function () {
                var valueArr = getValueAndText();
                ///alert($("#returnText").val());
                layer_to_page($("#returnIds").val(), $("#returnText").val(), inputId);//给页面赋值
        ...
        function layer_to_page(values_id, values_text, tarId) {
            ...
            if (emt == 'web') {//web
                ...
                obj.val(values_text);//给textarea赋值
                //药物应用
