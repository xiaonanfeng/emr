...
$(document).ready(function () {
    ...
    $(document).on("click", ".new_select_box dd", function () {
        ...
        //////清空
        var the_select = $(this).parent().parent().prev("select");
    ...
    $("select").each(function (index, element) {
        $(this).after("<span class='new_select_box' tabindex='-1'><input type='text' readonly class='new_select_input' placeholder=''><dl></dl></span>");
...
function kuangjia() {
    var window_width = $(window).width();//页面宽度
    var window_height = $(window).height();//页面高度
    father_width = window_width - 300;//页面宽度
    $("#Frame_tab_ul").width(father_width);
...
function build_new_tr(obj, can) {
    ...
    var new_NR = can;
    //临时测试作为内容输出
    //var new_NR = "<table width='100%' border='0' class='editForm'><tr> <td class='text_into'>数量:</td><td class='text_edit'>65</td><td class='text_into'>数据类型:</td><td class='text_edit'>SFP</td><td class='text_into'>数据数量:</td><td class='text_edit'>223</td></tr><tr> <td class='text_into'>已使用:</td><td class='text_edit'>56</td><td class='text_into'>未使用:</td><td class='text_edit'>32</td></tr><tr> <td class='text_into'>数量:</td><td class='text_edit'>65</td><td class='text_into'>未使用数量:</td><td class='text_edit'>43</td> <td class='text_into'>数量:</td><td class='text_edit'>65</td></tr><tr> <td class='text_into'>已使用:</td><td class='text_edit'>56</td> <td class='text_into'>数量:</td><td class='text_edit'>65</td><td class='text_into'>未使用:</td><td class='text_edit'>32</td></tr></table>";
...
function showalert(shuju) {
    ...
    var the_shuju = shuju + "<div style='text-align:center;'><a href='zx_list.html'  style='line-height:22px; color:#fff;' target='right' class='btn'>点击查看</a></div>>"
    if (TS == "none") {
        $("#slow_box").html();
