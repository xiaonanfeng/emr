...
<form id="vld_Ae_form">
    <div id="ae" title="辅助检查">
        <table width="100%" border="0" class="editForm">
            ...
            <tr hideGroup="thEcg">
                <th colspan="6" class="text_decollator"><span>心电图诊断</span>
                    <button class="btn btn_yellow" type="button" id="addEcg"
                            onclick="open_layer('选择心电图诊断','${ctx}/misEmrAe.do?method=findMultiSelects&values=${misEmrAe.ecgDiag}&flag=ecgDiag');">
                        添加心电图诊断
                    </button>
                </th>
            </tr>
            ...
            <tr>
                <td class="text_edit" colspan="6">
                    <input id=ecgOther
                           name="ecgOther" class="input_full" type="text" placeholder="其他">
                </td>
            </tr>
        </table>
    </div>
...
<div class="commitStyle${misEmrBasicinfo.isCommitted}">
    <button type="button" class="btn" id="saveAe">保存</button>
    <button type="button" class="btn commitButton">提交</button>
</div>	
