    ...
    <form id="vld_preaidVs_form">
        <table width="100%" border="0" class="editForm">
            ...
            <tr group="thSenRcd">
                <td>
				<textarea class="textarea_full"
                          style="width: 100%" id="sceneRecord" name="sceneRecord"
                          placeholder="现场抢救记录（针对现场抢救、复苏未成功或给予抢救未接回医院等）：2000字内">${misEmrPreaidVs.sceneRecord}</textarea>
                </td>
            </tr>
        ...
        <table width="100%" border="0" class="editForm">
            <tr>
                ...
                <td class="text_edit"><input id="signDate" name="signDate"
